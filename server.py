...
texts = {"help": ["Задайте мне вопрос \"Где поесть?\", и я отвечу где можно перекусить или "
         ...
         # Я могу помочь вам в выборе готовки, ресторана или назвать праздник на выбранную дату
...
def handle_dialog(res, req, user_id):
    if req['session']['new']:
        ...
        res["response"]["card"] = {"type": "BigImage",
                                   ...
                                   "title": f"{time_of_day}! Чтобы ознакомиться со мной, нажмите на кнопку \"Помощь\"."}
