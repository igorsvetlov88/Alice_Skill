...
texts = {"help": ["Задайте мне вопрос \"Где поесть?\", и я вам скажу где можно перекусить или "
                  "задайте вопрос \"Что мне приготовить\", и я помогу вам подобрать рецепт, "
                  "а можете задать вопрос \"Какой сегодня праздник?\" и я вам расскажу о сегодняшних праздниках, "
                  ...
                  "Задайте вопрос \"Что приготовить\", я расскажу вам какой-нибудь рецепт,\n"
...
def handle_dialog(res, req, user_id):
    if req['session']['new']:
        ...
        res["response"]["card"] = {"type": "BigImage",
                                   ...
                                   "title": f"{time_of_day}! Если возникнут вопросы, нажмите на кнопку или скажите \"Помощь\""}
